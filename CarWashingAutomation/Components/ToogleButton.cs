...
{
    class ToogleButton : Control
    {
        private float diameter;
        private ToogleButtonRectangle rect;
        ...
        public ToogleButton()
        {
            try
            {
                ...
                this.rect = new ToogleButtonRectangle(2f * this.diameter, this.diameter + 2f, this.diameter / 2f, 1f, 1f);
            ...
            {
                Logger.WriteLog("ToogleButton.ToogleButton -> ", _ex);
            }
        }
        protected override void OnEnabledChanged(EventArgs e)
        {
            ...
            {
                Logger.WriteLog("ToogleButton.OnEnabledChanged -> ", _ex);
            }
        }
        protected override void OnMouseDown(MouseEventArgs e)
        {
            ...
            {
                Logger.WriteLog("ToogleButton.OnMouseDown -> ", _ex);
            }
        }
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            {
                Logger.WriteLog("ToogleButton.OnPaint -> ", _ex);
            }
        }
        protected override void OnResize(EventArgs e)
        {
            ...
            {
                Logger.WriteLog("ToogleButton.OnResize -> ", _ex);
            }
        }
        private void paintTicker_Tick(object sender, EventArgs e)
        {
            ...
            {
                Logger.WriteLog("ToogleButton.paintTicker_Tick -> ", _ex);
            }
        }
    ...
    public class ToogleButtonRectangle
    {
        ...
        public ToogleButtonRectangle()
        {
        }
        public ToogleButtonRectangle(float width, float height, float radius, float x = 0f, float y = 0f)
        {
            try
            {
            ...
            {
                Logger.WriteLog("ToogleButtonRectangle.ToogleButtonRectangle -> ", _ex);
            }
        }
